            ...
            <div class="px-6 py-6 bg-gray-100">
                @if ($goal->id == $item->id)
                    <form wire:submit.prevent="update">
                        <input wire:model.live="goal.name" class="form-input w-full">
    ...
    <article class="bg-white shadow-lg rounded overflow-hidden">
        <div class="px-6 py-6 bg-gray-100">
            <form wire:submit.prevent="store">
                <input wire:model.live="name" class="form-input w-full" placeholder="Agregar el nombre de la meta">
