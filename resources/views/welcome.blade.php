<x-app-layout>
    ...
    <section class="mt-12">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-8">
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/telar.jpg')}}" alt="">
                </figure>
                <header class="mt-2">
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/albanil.jpg')}}" alt="">
                </figure>
                <header class="mt-2">
                    <h1 class="text-center text-xl text-gray-700">Novedades</h1>
                    <p class="text-sm text-gray-500">Aqui vamos a colocar alguna descripcion</p>
                </header>
            </article>
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/tecnologia.jpg')}}" alt="">
                </figure>
                <header class="mt-2">
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/gastronomia.jpg')}}" alt="">
                </figure>
                <header class="mt-2">
                    <h1 class="text-center text-xl text-gray-700">Contactos</h1>
                    <p class="text-sm text-gray-500">Aqui vamos a colocar algun formulario de contacto</p>
                </header>
            </article>
    ...
    <section class="mt-12">
        <h1 class="text-center text-3xl text-gray-600">Listado de cursos</h1>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-8">
